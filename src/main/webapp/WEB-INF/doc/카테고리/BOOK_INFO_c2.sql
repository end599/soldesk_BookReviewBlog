...
COMMENT ON COLUMN BOOK_INFO.SEQNO is '출력순서';
COMMENT ON COLUMN BOOK_INFO.VISIBLE is '출력 모드';
...
INSERT INTO BOOK_INFO(BOOKNO, BOOKNAME, WRITER, BOOKPDATE, BOOKPRICE) 
VALUES(bookinfo_seq.nextval, '눈 먼자들의 도시', '주제 사라마구', TO_DATE('2002-11-20', 'YYYY-MM-DD'), 11000);

INSERT INTO BOOK_INFO(BOOKNO, BOOKNAME, WRITER, BOOKPDATE, BOOKPRICE) 
VALUES(bookinfo_seq.nextval, '해가 지는 곳으로', '최진영', TO_DATE('2017-06-30', 'YYYY-MM-DD'), 12600);

INSERT INTO BOOK_INFO(BOOKNO, BOOKNAME, WRITER, BOOKPDATE, BOOKPRICE) 
VALUES(bookinfo_seq.nextval, '로드(THE ROAD)', '코맥 매카시', TO_DATE('2008-06-10', 'YYYY-MM-DD'), 11700);

INSERT INTO BOOK_INFO(BOOKNO, BOOKNAME, WRITER, BOOKPDATE, BOOKPRICE) 
VALUES(bookinfo_seq.nextval, '세계 대전 Z', '맥스 브룩스', TO_DATE('2006-09-12', 'YYYY-MM-DD'), 13800);

INSERT INTO BOOK_INFO(BOOKNO, BOOKNAME, WRITER, BOOKPDATE, BOOKPRICE, SEQNO) 
VALUES(bookinfo_seq.nextval, '테스트', '테스트', sysdate, 99999, 10);
